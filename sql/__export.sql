...
-- Singles --
\! echo '[Singles]';
\copy players.singles_games (reporter_id, player1_id, player2_id, points, team1_score, team2_score, timestamp, notes, tournament_game) TO './data/scores_singles.csv' WITH (FORMAT csv, HEADER);
